...
TRUNCATE TABLE  BOSS_DB.TARGET.D_BOSS_TIME_YEAR_T;

INSERT INTO BOSS_DB.TARGET.D_BOSS_TIME_YEAR_T (
	ID
	,YEAR_KY
	,YEAR_START_DATE
	,YEAR_END_DATE
...
SELECT DISTINCT (TO_CHAR(MY_DATE, 'YYYY'))
	...
	,sysdate()
FROM (
	SELECT DATEADD(DAY, SEQ4(), TO_DATE('2017', 'YYYY')) AS MY_DATE
	FROM TABLE (GENERATOR(ROWCOUNT => 3650))
	)
ORDER BY 1;

TRUNCATE TABLE  BOSS_DB.TARGET.D_BOSS_TIME_HALF_YEAR_T;

INSERT INTO BOSS_DB.TARGET.D_BOSS_TIME_HALF_YEAR_T (
	ID
	,HALF_YEAR_KY
	,YEAR_KY
...
TRUNCATE TABLE  BOSS_DB.TARGET.D_BOSS_TIME_QUARTER_T;

INSERT INTO BOSS_DB.TARGET.D_BOSS_TIME_QUARTER_T (
	ID
	,QUARTER_KY
	,YEAR_KY
	,HALF_YEAR_KY
...
TRUNCATE TABLE  BOSS_DB.TARGET.D_BOSS_TIME_MONTH_T;

INSERT INTO BOSS_DB.TARGET.D_BOSS_TIME_MONTH_T (
	ID
	,MONTH_KY
	,MONTH_DESC
	,QUARTER_KY
...
TRUNCATE TABLE  BOSS_DB.TARGET.D_BOSS_TIME_DAY_T;

INSERT INTO BOSS_DB.TARGET.D_BOSS_TIME_DAY_T (
	ID
	,DAY_KY
	,MONTH_KY
	,QUARTER_KY
