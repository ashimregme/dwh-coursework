...
CREATE
OR REPLACE TABLE TARGET.D_BOSS_LOCN_T (
...
CREATE
OR REPLACE TABLE TARGET.D_BOSS_LYLTY_CRD_T (
...
CREATE
OR REPLACE TABLE TARGET.D_BOSS_CSTMR_T (
...
CREATE
OR REPLACE TABLE TARGET.D_BOSS_PRMTN_SCHM_T (
	PRMTN_SCHM_ID NUMBER(38, 0) NOT NULL,
	PRMTN_SCHM_KY NUMBER(38, 0) NOT NULL autoincrement,
...
CREATE
OR REPLACE TABLE TARGET.F_BOSS_PRC_T (
...
CREATE
OR REPLACE TABLE TARGET.F_BOSS_AGG_SLS_PLC_MONTH_T (
	ROW_KEY NUMBER(38, 0) NOT NULL autoincrement,
	LOCN_KY NUMBER(38, 0) NOT NULL,
	PDT_KY NUMBER(38, 0) NOT NULL,
...
CREATE
OR REPLACE TABLE TARGET.F_BOSS_SLS_T (
	ROW_KEY NUMBER(38, 0) NOT NULL autoincrement,
...
CREATE
OR REPLACE TABLE TARGET.F_BOSS_AGG_PRC_PLD_DAY_T (
	ROW_KEY NUMBER(38, 0) NOT NULL autoincrement,
	PDT_KY NUMBER(38, 0) NOT NULL,
	LOCN_KY NUMBER(38, 0) NOT NULL,
...
-- Calendar DDL
CREATE
OR REPLACE TABLE TARGET.D_BOSS_TIME_SEC_T (
	ID NUMBER(38, 0),
...
CREATE
OR REPLACE TABLE TARGET.D_BOSS_TIME_MIN_T (
	ID NUMBER(38, 0),
...
CREATE
OR REPLACE TABLE TARGET.D_BOSS_TIME_HOUR_T (
	ID NUMBER(38, 0),
...
CREATE
OR REPLACE TABLE TARGET.D_BOSS_TIME_DAY_T (
	ID DATE NOT NULL,
	DAY_KY NUMBER(38, 0) NOT NULL,
...
CREATE
OR REPLACE TABLE TARGET.D_BOSS_TIME_MONTH_T (
	ID VARCHAR() NOT NULL,
	MONTH_KY NUMBER(38, 0) NOT NULL,
...
CREATE
OR REPLACE TABLE TARGET.D_BOSS_TIME_QUARTER_T (
	ID VARCHAR NOT NULL,
	QUARTER_KY NUMBER(38, 0) NOT NULL,
	YEAR_KY NUMBER(38, 0) NOT NULL,
	HALF_YEAR_KY NUMBER(38, 0) NOT NULL,
...
CREATE
OR REPLACE TABLE TARGET.D_BOSS_TIME_HALF_YEAR_T (
	ID VARCHAR() NOT NULL,
	HALF_YEAR_KY NUMBER(38, 0) NOT NULL,
	YEAR_KY NUMBER(38, 0) NOT NULL,
...
CREATE
OR REPLACE TABLE TARGET.D_BOSS_TIME_YEAR_T (
	ID NUMBER(38, 0),
	YEAR_KY NUMBER(38, 0) NOT NULL,
